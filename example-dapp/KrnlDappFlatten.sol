...
contract KrnlDapp is IERC1271 {
    ...
    event GetCounter(address from, uint256 counter);
    ...
    function unprotectFunctionShouldReturn() external returns(uint256) {
        emit GetCounter(msg.sender, counter);
        return counter;
    }
}
